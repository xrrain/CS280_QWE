...
def main():
    ...
    System = QweTool()
    top001, top005, top01, kendal, run_time = System.evaluateRealData("/root/CS280_QWE/model/nrange_iter_100_200_4500.ckpt", "/p300/data/GNN_Data/Real/com-youtube.txt", "/p300/data/GNN_Data/Real/exact_bc/com-youtube.txt")
